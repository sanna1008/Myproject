...
public class CommentService {
    ...
    public String addComment(CommentRequest request) {
    	// Basic validation
        if (request == null || request.getCommentFrom() == null || request.getCommentTo() == null || request.getMessage() == null) {
            return "Invalid request";
        }

        // Check if the user to whom the comment is being commented is present in the user table
        ...
        comment.setPostedByUser(userRepository.findByCommentFrom(request.getCommentFrom())); // Assuming findByCommentFrom exists
